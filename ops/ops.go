...
func Register_BIDIRECTIONAL_SEQUENCE_RNN() *tflite.ExpRegistration {
	return wrap(C.Register_BIDIRECTIONAL_SEQUENCE_RNN())
}
func Register_UNIDIRECTIONAL_SEQUENCE_RNN() *tflite.ExpRegistration {
	return wrap(C.Register_UNIDIRECTIONAL_SEQUENCE_RNN())
}
func Register_EMBEDDING_LOOKUP() *tflite.ExpRegistration { return wrap(C.Register_EMBEDDING_LOOKUP()) }
func Register_EMBEDDING_LOOKUP_SPARSE() *tflite.ExpRegistration {
	return wrap(C.Register_EMBEDDING_LOOKUP_SPARSE())
}
...
func Register_BATCH_TO_SPACE_ND_REF() *tflite.ExpRegistration {
	return wrap(C.Register_BATCH_TO_SPACE_ND_REF())
}
...
func Register_LOCAL_RESPONSE_NORM_REF() *tflite.ExpRegistration {
	return wrap(C.Register_LOCAL_RESPONSE_NORM_REF())
}
func Register_LSTM() *tflite.ExpRegistration { return wrap(C.Register_LSTM()) }
func Register_BIDIRECTIONAL_SEQUENCE_LSTM() *tflite.ExpRegistration {
	return wrap(C.Register_BIDIRECTIONAL_SEQUENCE_LSTM())
}
func Register_UNIDIRECTIONAL_SEQUENCE_LSTM() *tflite.ExpRegistration {
	return wrap(C.Register_UNIDIRECTIONAL_SEQUENCE_LSTM())
}
...
func Register_RESIZE_BILINEAR_REF() *tflite.ExpRegistration {
	return wrap(C.Register_RESIZE_BILINEAR_REF())
}
func Register_RESIZE_NEAREST_NEIGHBOR_REF() *tflite.ExpRegistration {
	return wrap(C.Register_RESIZE_NEAREST_NEIGHBOR_REF())
}
